...
internal sealed partial class AuthenticateResponseConverter : System.Text.Json.Serialization.JsonConverter<AuthenticateResponse>
{
	...
	public override AuthenticateResponse Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Security.AuthenticateApiKey?> propApiKey = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Security.RealmInfo> propAuthenticationRealm = default;
		...
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Security.RealmInfo> propLookupRealm = default;
		...
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Security.AuthenticateToken?> propToken = default;
