...
internal sealed partial class UpdateTransformResponseConverter : System.Text.Json.Serialization.JsonConverter<UpdateTransformResponse>
{
	...
	public override UpdateTransformResponse Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		LocalJsonProperty<Elastic.Clients.Elasticsearch.MachineLearning.TransformAuthorization?> propAuthorization = default;
		LocalJsonProperty<long> propCreateTime = default;
		LocalJsonProperty<string> propDescription = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Core.Reindex.Destination> propDest = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Duration?> propFrequency = default;
		LocalJsonProperty<string> propId = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.TransformManagement.Latest?> propLatest = default;
		LocalJsonProperty<IReadOnlyDictionary<string, object>?> propMeta = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.TransformManagement.Pivot?> propPivot = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.TransformManagement.RetentionPolicy?> propRetentionPolicy = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.TransformManagement.Settings> propSettings = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Core.Reindex.Source> propSource = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.TransformManagement.Sync?> propSync = default;
