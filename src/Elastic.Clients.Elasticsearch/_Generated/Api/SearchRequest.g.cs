...
internal sealed partial class SearchRequestConverter : System.Text.Json.Serialization.JsonConverter<SearchRequest>
{
	...
	public override SearchRequest Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Core.Search.FieldCollapse?> propCollapse = default;
		LocalJsonProperty<ICollection<Elastic.Clients.Elasticsearch.QueryDsl.FieldAndFormat>?> propDocvalueFields = default;
		LocalJsonProperty<bool?> propExplain = default;
		LocalJsonProperty<IDictionary<string, object>?> propExt = default;
		LocalJsonProperty<ICollection<Elastic.Clients.Elasticsearch.QueryDsl.FieldAndFormat>?> propFields = default;
		LocalJsonProperty<int?> propFrom = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Core.Search.Highlight?> propHighlight = default;
		LocalJsonProperty<ICollection<IDictionary<Elastic.Clients.Elasticsearch.IndexName, double>>?> propIndicesBoost = default;
		LocalJsonProperty<ICollection<Elastic.Clients.Elasticsearch.KnnSearch>?> propKnn = default;
		LocalJsonProperty<double?> propMinScore = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Core.Search.PointInTimeReference?> propPit = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.QueryDsl.Query?> propPostFilter = default;
		LocalJsonProperty<bool?> propProfile = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.QueryDsl.Query?> propQuery = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Rank?> propRank = default;
		LocalJsonProperty<ICollection<Elastic.Clients.Elasticsearch.Core.Search.Rescore>?> propRescore = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Retriever?> propRetriever = default;
		LocalJsonProperty<IDictionary<Elastic.Clients.Elasticsearch.Field, Elastic.Clients.Elasticsearch.Mapping.RuntimeField>?> propRuntimeMappings = default;
		LocalJsonProperty<IDictionary<string, Elastic.Clients.Elasticsearch.ScriptField>?> propScriptFields = default;
		LocalJsonProperty<ICollection<Elastic.Clients.Elasticsearch.FieldValue>?> propSearchAfter = default;
		LocalJsonProperty<bool?> propSeqNoPrimaryTerm = default;
		LocalJsonProperty<int?> propSize = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.SlicedScroll?> propSlice = default;
		LocalJsonProperty<ICollection<Elastic.Clients.Elasticsearch.SortOptions>?> propSort = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Core.Search.SourceConfig?> propSource = default;
		LocalJsonProperty<ICollection<string>?> propStats = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Fields?> propStoredFields = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Core.Search.Suggester?> propSuggest = default;
		...
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Core.Search.TrackHits?> propTrackTotalHits = default;
		...
		while (reader.Read() && reader.TokenType is System.Text.Json.JsonTokenType.PropertyName)
		{
			...
			if (propKnn.TryRead(ref reader, options, PropKnn, typeof(SingleOrManyMarker<IReadOnlyCollection<Elastic.Clients.Elasticsearch.KnnSearch>?, Elastic.Clients.Elasticsearch.KnnSearch>)))
			{
				continue;
			}
			...
			if (propRescore.TryRead(ref reader, options, PropRescore, typeof(SingleOrManyMarker<IReadOnlyCollection<Elastic.Clients.Elasticsearch.Core.Search.Rescore>?, Elastic.Clients.Elasticsearch.Core.Search.Rescore>)))
			{
				continue;
			}
	...
	public override void Write(System.Text.Json.Utf8JsonWriter writer, SearchRequest value, System.Text.Json.JsonSerializerOptions options)
	{
		...
		writer.WriteProperty(options, PropKnn, value.Knn, typeof(SingleOrManyMarker<IReadOnlyCollection<Elastic.Clients.Elasticsearch.KnnSearch>?, Elastic.Clients.Elasticsearch.KnnSearch>));
		...
		writer.WriteProperty(options, PropRescore, value.Rescore, typeof(SingleOrManyMarker<IReadOnlyCollection<Elastic.Clients.Elasticsearch.Core.Search.Rescore>?, Elastic.Clients.Elasticsearch.Core.Search.Rescore>));
		...
		writer.WriteProperty(options, PropSort, value.Sort, typeof(SingleOrManyMarker<IReadOnlyCollection<Elastic.Clients.Elasticsearch.SortOptions>?, Elastic.Clients.Elasticsearch.SortOptions>));
