...
internal sealed partial class PutMappingRequestConverter : System.Text.Json.Serialization.JsonConverter<PutMappingRequest>
{
	...
	public override PutMappingRequest Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		LocalJsonProperty<ICollection<IDictionary<string, Elastic.Clients.Elasticsearch.Mapping.DynamicTemplate>>?> propDynamicTemplates = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Mapping.FieldNamesField?> propFieldNames = default;
		...
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Mapping.RoutingField?> propRouting = default;
		LocalJsonProperty<IDictionary<Elastic.Clients.Elasticsearch.Field, Elastic.Clients.Elasticsearch.Mapping.RuntimeField>?> propRuntime = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Mapping.SourceField?> propSource = default;
		while (reader.Read() && reader.TokenType is System.Text.Json.JsonTokenType.PropertyName)
		{
			...
			if (propDynamicTemplates.TryRead(ref reader, options, PropDynamicTemplates, typeof(SingleOrManyMarker<IReadOnlyCollection<IReadOnlyDictionary<string, Elastic.Clients.Elasticsearch.Mapping.DynamicTemplate>>?, IReadOnlyDictionary<string, Elastic.Clients.Elasticsearch.Mapping.DynamicTemplate>>)))
			{
				continue;
			}
	...
	public override void Write(System.Text.Json.Utf8JsonWriter writer, PutMappingRequest value, System.Text.Json.JsonSerializerOptions options)
	{
		...
		writer.WriteProperty(options, PropDynamicTemplates, value.DynamicTemplates, typeof(SingleOrManyMarker<IReadOnlyCollection<IReadOnlyDictionary<string, Elastic.Clients.Elasticsearch.Mapping.DynamicTemplate>>?, IReadOnlyDictionary<string, Elastic.Clients.Elasticsearch.Mapping.DynamicTemplate>>));
