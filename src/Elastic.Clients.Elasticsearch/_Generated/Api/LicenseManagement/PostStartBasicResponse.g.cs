...
internal sealed partial class PostStartBasicResponseConverter : System.Text.Json.Serialization.JsonConverter<PostStartBasicResponse>
{
	...
	public override PostStartBasicResponse Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		LocalJsonProperty<IReadOnlyDictionary<string, Union<string, IReadOnlyCollection<string>>>?> propAcknowledge = default;
		LocalJsonProperty<bool> propAcknowledged = default;
		LocalJsonProperty<bool> propBasicWasStarted = default;
		LocalJsonProperty<string?> propErrorMessage = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.LicenseManagement.LicenseType?> propType = default;
