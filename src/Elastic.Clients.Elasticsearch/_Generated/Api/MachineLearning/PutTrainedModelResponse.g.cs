...
internal sealed partial class PutTrainedModelResponseConverter : System.Text.Json.Serialization.JsonConverter<PutTrainedModelResponse>
{
	...
	public override PutTrainedModelResponse Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		LocalJsonProperty<Elastic.Clients.Elasticsearch.MachineLearning.InferenceConfigCreate?> propInferenceConfig = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.MachineLearning.TrainedModelConfigInput> propInput = default;
		LocalJsonProperty<string?> propLicenseLevel = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.MachineLearning.TrainedModelLocation?> propLocation = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.MachineLearning.TrainedModelConfigMetadata?> propMetadata = default;
		LocalJsonProperty<string> propModelId = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.MachineLearning.ModelPackageConfig?> propModelPackage = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.ByteSize?> propModelSizeBytes = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.MachineLearning.TrainedModelType?> propModelType = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.MachineLearning.TrainedModelPrefixStrings?> propPrefixStrings = default;
