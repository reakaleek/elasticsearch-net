...
internal sealed partial class PutJobResponseConverter : System.Text.Json.Serialization.JsonConverter<PutJobResponse>
{
	...
	public override PutJobResponse Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		LocalJsonProperty<Elastic.Clients.Elasticsearch.MachineLearning.AnalysisConfigRead> propAnalysisConfig = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.MachineLearning.AnalysisLimits> propAnalysisLimits = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Duration?> propBackgroundPersistInterval = default;
		...
		LocalJsonProperty<Elastic.Clients.Elasticsearch.MachineLearning.DataDescription> propDataDescription = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.MachineLearning.Datafeed?> propDatafeedConfig = default;
		...
		LocalJsonProperty<Elastic.Clients.Elasticsearch.MachineLearning.ModelPlotConfig?> propModelPlotConfig = default;
