...
internal sealed partial class UpdateDatafeedResponseConverter : System.Text.Json.Serialization.JsonConverter<UpdateDatafeedResponse>
{
	...
	public override UpdateDatafeedResponse Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		LocalJsonProperty<IReadOnlyDictionary<string, Elastic.Clients.Elasticsearch.Aggregations.Aggregation>?> propAggregations = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.MachineLearning.DatafeedAuthorization?> propAuthorization = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.MachineLearning.ChunkingConfig> propChunkingConfig = default;
		LocalJsonProperty<string> propDatafeedId = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.MachineLearning.DelayedDataCheckConfig?> propDelayedDataCheckConfig = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Duration?> propFrequency = default;
		LocalJsonProperty<IReadOnlyCollection<string>> propIndices = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.IndicesOptions?> propIndicesOptions = default;
		...
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Duration> propQueryDelay = default;
		LocalJsonProperty<IReadOnlyDictionary<string, Elastic.Clients.Elasticsearch.Mapping.RuntimeField>?> propRuntimeMappings = default;
		LocalJsonProperty<IReadOnlyDictionary<string, Elastic.Clients.Elasticsearch.ScriptField>?> propScriptFields = default;
