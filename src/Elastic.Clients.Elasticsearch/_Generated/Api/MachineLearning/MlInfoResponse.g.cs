...
internal sealed partial class MlInfoResponseConverter : System.Text.Json.Serialization.JsonConverter<MlInfoResponse>
{
	...
	public override MlInfoResponse Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		LocalJsonProperty<Elastic.Clients.Elasticsearch.MachineLearning.Defaults> propDefaults = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.MachineLearning.Limits> propLimits = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.MachineLearning.NativeCode> propNativeCode = default;
