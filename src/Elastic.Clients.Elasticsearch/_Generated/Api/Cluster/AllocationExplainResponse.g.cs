...
internal sealed partial class AllocationExplainResponseConverter : System.Text.Json.Serialization.JsonConverter<AllocationExplainResponse>
{
	...
	public override AllocationExplainResponse Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Duration?> propAllocationDelay = default;
		LocalJsonProperty<long?> propAllocationDelayInMillis = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Cluster.Decision?> propCanAllocate = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Cluster.Decision?> propCanMoveToOtherNode = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Cluster.Decision?> propCanRebalanceCluster = default;
		LocalJsonProperty<IReadOnlyCollection<Elastic.Clients.Elasticsearch.Cluster.AllocationDecision>?> propCanRebalanceClusterDecisions = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Cluster.Decision?> propCanRebalanceToOtherNode = default;
		LocalJsonProperty<IReadOnlyCollection<Elastic.Clients.Elasticsearch.Cluster.AllocationDecision>?> propCanRemainDecisions = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Cluster.Decision?> propCanRemainOnCurrentNode = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Cluster.ClusterInfo?> propClusterInfo = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Duration?> propConfiguredDelay = default;
		LocalJsonProperty<long?> propConfiguredDelayInMillis = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Cluster.CurrentNode?> propCurrentNode = default;
		...
		LocalJsonProperty<IReadOnlyCollection<Elastic.Clients.Elasticsearch.Cluster.NodeAllocationExplanation>?> propNodeAllocationDecisions = default;
		...
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Duration?> propRemainingDelay = default;
		LocalJsonProperty<long?> propRemainingDelayInMillis = default;
		LocalJsonProperty<int> propShard = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Cluster.UnassignedInformation?> propUnassignedInfo = default;
