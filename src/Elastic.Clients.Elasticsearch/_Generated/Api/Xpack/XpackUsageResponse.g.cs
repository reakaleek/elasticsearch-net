...
internal sealed partial class XpackUsageResponseConverter : System.Text.Json.Serialization.JsonConverter<XpackUsageResponse>
{
	...
	public override XpackUsageResponse Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Xpack.Base> propAggregateMetric = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Xpack.Analytics> propAnalytics = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Xpack.Archive> propArchive = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Xpack.Ccr> propCcr = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Xpack.Base?> propDataFrame = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Xpack.Base?> propDataScience = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Xpack.DataStreams?> propDataStreams = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Xpack.DataTiers> propDataTiers = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Xpack.Base?> propEnrich = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Xpack.Eql> propEql = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Xpack.Flattened?> propFlattened = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Xpack.FrozenIndices> propFrozenIndices = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Xpack.Base> propGraph = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Xpack.HealthStatistics?> propHealthApi = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Xpack.Ilm> propIlm = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Xpack.Base> propLogstash = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Xpack.MachineLearning> propMl = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Xpack.Monitoring> propMonitoring = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Xpack.Base> propRollup = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Xpack.RuntimeFieldTypes?> propRuntimeFields = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Xpack.SearchableSnapshots> propSearchableSnapshots = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Xpack.Security> propSecurity = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Xpack.Slm> propSlm = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Xpack.Base> propSpatial = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Xpack.Sql> propSql = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Xpack.Base> propTransform = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Xpack.Vector?> propVectors = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Xpack.Base> propVotingOnly = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Xpack.Watcher> propWatcher = default;
