...
internal sealed partial class FindMessageStructureResponseConverter : System.Text.Json.Serialization.JsonConverter<FindMessageStructureResponse>
{
	...
	public override FindMessageStructureResponse Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		LocalJsonProperty<string> propCharset = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.TextStructure.EcsCompatibilityType?> propEcsCompatibility = default;
		LocalJsonProperty<IReadOnlyDictionary<Elastic.Clients.Elasticsearch.Field, Elastic.Clients.Elasticsearch.TextStructure.FieldStat>> propFieldStats = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.TextStructure.FormatType> propFormat = default;
		LocalJsonProperty<string?> propGrokPattern = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Ingest.PipelineConfig> propIngestPipeline = default;
		LocalJsonProperty<IReadOnlyCollection<string>?> propJavaTimestampFormats = default;
		LocalJsonProperty<IReadOnlyCollection<string>?> propJodaTimestampFormats = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Mapping.TypeMapping> propMappings = default;
		LocalJsonProperty<string?> propMultilineStartPattern = default;
		LocalJsonProperty<bool> propNeedClientTimezone = default;
		LocalJsonProperty<int> propNumLinesAnalyzed = default;
		LocalJsonProperty<int> propNumMessagesAnalyzed = default;
		LocalJsonProperty<string> propSampleStart = default;
