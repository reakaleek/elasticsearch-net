...
internal sealed partial class EqlSearchRequestConverter : System.Text.Json.Serialization.JsonConverter<EqlSearchRequest>
{
	...
	public override EqlSearchRequest Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Field?> propEventCategoryField = default;
		...
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Duration?> propKeepAlive = default;
		...
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Eql.ResultPosition?> propResultPosition = default;
		...
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Field?> propTiebreakerField = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Field?> propTimestampField = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Duration?> propWaitForCompletionTimeout = default;
		while (reader.Read() && reader.TokenType is System.Text.Json.JsonTokenType.PropertyName)
		{
			...
			if (propFields.TryRead(ref reader, options, PropFields, typeof(SingleOrManyMarker<IReadOnlyCollection<Elastic.Clients.Elasticsearch.QueryDsl.FieldAndFormat>?, Elastic.Clients.Elasticsearch.QueryDsl.FieldAndFormat>)))
			{
				continue;
			}
	...
	public override void Write(System.Text.Json.Utf8JsonWriter writer, EqlSearchRequest value, System.Text.Json.JsonSerializerOptions options)
	{
		...
		writer.WriteProperty(options, PropFields, value.Fields, typeof(SingleOrManyMarker<IReadOnlyCollection<Elastic.Clients.Elasticsearch.QueryDsl.FieldAndFormat>?, Elastic.Clients.Elasticsearch.QueryDsl.FieldAndFormat>));
