...
internal sealed partial class SearchApplicationSearchResponseConverter<TDocument> : System.Text.Json.Serialization.JsonConverter<SearchApplicationSearchResponse<TDocument>>
{
	...
	public override SearchApplicationSearchResponse<TDocument> Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		reader.ValidateToken(System.Text.Json.JsonTokenType.StartObject);
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Aggregations.AggregateDictionary?> propAggregations = default;
		...
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Core.Search.HitsMetadata<TDocument>> propHitsMetadata = default;
		...
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Core.Search.Profile?> propProfile = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.ScrollId?> propScrollId = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.ShardStatistics> propShards = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Core.Search.SuggestDictionary<TDocument>?> propSuggest = default;
		...
		return new SearchApplicationSearchResponse<TDocument>
		{
...
internal sealed partial class SearchApplicationSearchResponseConverterFactory : System.Text.Json.Serialization.JsonConverterFactory
{
	public override bool CanConvert(System.Type typeToConvert)
	{
		return typeToConvert.IsGenericType && typeToConvert.GetGenericTypeDefinition() == typeof(SearchApplicationSearchResponse<>);
	}
...
#pragma warning disable IL3050
		var converter = (System.Text.Json.Serialization.JsonConverter)System.Activator.CreateInstance(typeof(SearchApplicationSearchResponseConverter<>).MakeGenericType(args[0]), System.Reflection.BindingFlags.Instance | System.Reflection.BindingFlags.Public, binder: null, args: null, culture: null)!;
#pragma warning restore IL3050
		return converter;
	}
}

[JsonConverter(typeof(SearchApplicationSearchResponseConverterFactory))]
public sealed partial class SearchApplicationSearchResponse<TDocument> : ElasticsearchResponse
{
