...
internal sealed partial class GetSearchApplicationResponseConverter : System.Text.Json.Serialization.JsonConverter<GetSearchApplicationResponse>
{
	...
	public override GetSearchApplicationResponse Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		LocalJsonProperty<string?> propAnalyticsCollectionName = default;
		LocalJsonProperty<IReadOnlyCollection<string>> propIndices = default;
		LocalJsonProperty<string> propName = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.SearchApplication.SearchApplicationTemplate?> propTemplate = default;
		LocalJsonProperty<long> propUpdatedAtMillis = default;
