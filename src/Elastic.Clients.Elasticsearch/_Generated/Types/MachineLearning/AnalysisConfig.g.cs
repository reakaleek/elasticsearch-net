...
internal sealed partial class AnalysisConfigConverter : System.Text.Json.Serialization.JsonConverter<AnalysisConfig>
{
	...
	public override AnalysisConfig Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Duration?> propBucketSpan = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.MachineLearning.CategorizationAnalyzer?> propCategorizationAnalyzer = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Field?> propCategorizationFieldName = default;
		LocalJsonProperty<ICollection<string>?> propCategorizationFilters = default;
		LocalJsonProperty<ICollection<Elastic.Clients.Elasticsearch.MachineLearning.Detector>> propDetectors = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Fields?> propInfluencers = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Duration?> propLatency = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Duration?> propModelPruneWindow = default;
		LocalJsonProperty<bool?> propMultivariateByFields = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.MachineLearning.PerPartitionCategorization?> propPerPartitionCategorization = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Field?> propSummaryCountFieldName = default;
