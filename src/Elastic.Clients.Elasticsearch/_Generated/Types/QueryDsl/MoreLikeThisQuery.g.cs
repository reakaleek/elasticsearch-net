...
internal sealed partial class MoreLikeThisQueryConverter : System.Text.Json.Serialization.JsonConverter<MoreLikeThisQuery>
{
	...
	public override MoreLikeThisQuery Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		LocalJsonProperty<ICollection<Elastic.Clients.Elasticsearch.QueryDsl.Like>> propLike = default;
		...
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Routing?> propRouting = default;
		LocalJsonProperty<ICollection<string>?> propStopWords = default;
		LocalJsonProperty<ICollection<Elastic.Clients.Elasticsearch.QueryDsl.Like>?> propUnlike = default;
		...
		while (reader.Read() && reader.TokenType is System.Text.Json.JsonTokenType.PropertyName)
		{
			...
			if (propLike.TryRead(ref reader, options, PropLike, typeof(SingleOrManyMarker<IReadOnlyCollection<Elastic.Clients.Elasticsearch.QueryDsl.Like>, Elastic.Clients.Elasticsearch.QueryDsl.Like>)))
			{
				continue;
			}
			...
			if (propUnlike.TryRead(ref reader, options, PropUnlike, typeof(SingleOrManyMarker<IReadOnlyCollection<Elastic.Clients.Elasticsearch.QueryDsl.Like>?, Elastic.Clients.Elasticsearch.QueryDsl.Like>)))
			{
				continue;
			}
...
,
	...
	public override void Write(System.Text.Json.Utf8JsonWriter writer, MoreLikeThisQuery value, System.Text.Json.JsonSerializerOptions options)
	{
		...
		writer.WriteProperty(options, PropLike, value.Like, typeof(SingleOrManyMarker<IReadOnlyCollection<Elastic.Clients.Elasticsearch.QueryDsl.Like>, Elastic.Clients.Elasticsearch.QueryDsl.Like>));
		...
		writer.WriteProperty(options, PropUnlike, value.Unlike, typeof(SingleOrManyMarker<IReadOnlyCollection<Elastic.Clients.Elasticsearch.QueryDsl.Like>?, Elastic.Clients.Elasticsearch.QueryDsl.Like>));
