...
internal sealed partial class DateRangeQueryConverter : System.Text.Json.Serialization.JsonConverter<DateRangeQuery>
{
	...
	public override DateRangeQuery Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		LocalJsonProperty<Elastic.Clients.Elasticsearch.DateMath?> propGt = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.DateMath?> propGte = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.DateMath?> propLt = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.DateMath?> propLte = default;
		LocalJsonProperty<string?> propQueryName = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.QueryDsl.RangeRelation?> propRelation = default;
