...
internal sealed partial class PhoneticTokenFilterConverter : System.Text.Json.Serialization.JsonConverter<PhoneticTokenFilter>
{
	...
	public override PhoneticTokenFilter Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Analysis.PhoneticEncoder> propEncoder = default;
		LocalJsonProperty<ICollection<Elastic.Clients.Elasticsearch.Analysis.PhoneticLanguage>?> propLanguageset = default;
		LocalJsonProperty<int?> propMaxCodeLen = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Analysis.PhoneticNameType?> propNameType = default;
		LocalJsonProperty<bool?> propReplace = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Analysis.PhoneticRuleType?> propRuleType = default;
		...
		while (reader.Read() && reader.TokenType is System.Text.Json.JsonTokenType.PropertyName)
		{
			...
			if (propLanguageset.TryRead(ref reader, options, PropLanguageset, typeof(SingleOrManyMarker<IReadOnlyCollection<Elastic.Clients.Elasticsearch.Analysis.PhoneticLanguage>?, Elastic.Clients.Elasticsearch.Analysis.PhoneticLanguage>)))
			{
				continue;
			}
...
,
	...
	public override void Write(System.Text.Json.Utf8JsonWriter writer, PhoneticTokenFilter value, System.Text.Json.JsonSerializerOptions options)
	{
		...
		writer.WriteProperty(options, PropLanguageset, value.Languageset, typeof(SingleOrManyMarker<IReadOnlyCollection<Elastic.Clients.Elasticsearch.Analysis.PhoneticLanguage>?, Elastic.Clients.Elasticsearch.Analysis.PhoneticLanguage>));
