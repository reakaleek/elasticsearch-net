...
internal sealed partial class QueryRoleConverter : System.Text.Json.Serialization.JsonConverter<QueryRole>
{
	...
	public override QueryRole Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		LocalJsonProperty<IReadOnlyCollection<Elastic.Clients.Elasticsearch.Security.ApplicationPrivileges>?> propApplications = default;
		LocalJsonProperty<IReadOnlyCollection<Elastic.Clients.Elasticsearch.Security.ClusterPrivilege>?> propCluster = default;
		LocalJsonProperty<string?> propDescription = default;
		LocalJsonProperty<IReadOnlyCollection<Elastic.Clients.Elasticsearch.Security.GlobalPrivilege>?> propGlobal = default;
		LocalJsonProperty<IReadOnlyCollection<Elastic.Clients.Elasticsearch.Security.IndicesPrivileges>?> propIndices = default;
		LocalJsonProperty<IReadOnlyDictionary<string, object>?> propMetadata = default;
		LocalJsonProperty<string> propName = default;
		LocalJsonProperty<IReadOnlyCollection<Elastic.Clients.Elasticsearch.Security.RemoteClusterPrivileges>?> propRemoteCluster = default;
		LocalJsonProperty<IReadOnlyCollection<Elastic.Clients.Elasticsearch.Security.RemoteIndicesPrivileges>?> propRemoteIndices = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Security.Restriction?> propRestriction = default;
		LocalJsonProperty<IReadOnlyCollection<string>?> propRunAs = default;
		LocalJsonProperty<IReadOnlyCollection<Elastic.Clients.Elasticsearch.FieldValue>?> propSort = default;
...
,
	...
	public override void Write(System.Text.Json.Utf8JsonWriter writer, QueryRole value, System.Text.Json.JsonSerializerOptions options)
	{
		...
		writer.WriteProperty(options, PropGlobal, value.Global, typeof(SingleOrManyMarker<IReadOnlyCollection<Elastic.Clients.Elasticsearch.Security.GlobalPrivilege>?, Elastic.Clients.Elasticsearch.Security.GlobalPrivilege>));
