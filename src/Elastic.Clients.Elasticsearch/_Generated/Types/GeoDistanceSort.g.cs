...
internal sealed partial class GeoDistanceSortConverter : System.Text.Json.Serialization.JsonConverter<GeoDistanceSort>
{
	...
	public override GeoDistanceSort Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		LocalJsonProperty<ICollection<Elastic.Clients.Elasticsearch.GeoLocation>> propLocation = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.GeoDistanceType?> propDistanceType = default;
		...
		LocalJsonProperty<Elastic.Clients.Elasticsearch.NestedSortValue?> propNested = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.SortOrder?> propOrder = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.DistanceUnit?> propUnit = default;
		while (reader.Read() && reader.TokenType is System.Text.Json.JsonTokenType.PropertyName)
		{
			...
			reader.ReadProperty(options, out propField.Value, out propLocation.Value, typeof(SingleOrManyMarker<IReadOnlyCollection<Elastic.Clients.Elasticsearch.GeoLocation>, Elastic.Clients.Elasticsearch.GeoLocation>));
		}
...
,
	...
	public override void Write(System.Text.Json.Utf8JsonWriter writer, GeoDistanceSort value, System.Text.Json.JsonSerializerOptions options)
	{
		...
		writer.WriteProperty(options, value.Field, value.Location, typeof(SingleOrManyMarker<IReadOnlyCollection<Elastic.Clients.Elasticsearch.GeoLocation>, Elastic.Clients.Elasticsearch.GeoLocation>));
