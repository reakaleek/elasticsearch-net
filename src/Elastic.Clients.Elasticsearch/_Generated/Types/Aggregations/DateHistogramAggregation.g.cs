...
internal sealed partial class DateHistogramAggregationConverter : System.Text.Json.Serialization.JsonConverter<DateHistogramAggregation>
{
	...
	public override DateHistogramAggregation Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Aggregations.CalendarInterval?> propCalendarInterval = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Aggregations.ExtendedBoundsDate?> propExtendedBounds = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Field?> propField = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Duration?> propFixedInterval = default;
		LocalJsonProperty<string?> propFormat = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Aggregations.ExtendedBoundsDate?> propHardBounds = default;
		LocalJsonProperty<int?> propMinDocCount = default;
		LocalJsonProperty<DateTimeOffset?> propMissing = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Duration?> propOffset = default;
