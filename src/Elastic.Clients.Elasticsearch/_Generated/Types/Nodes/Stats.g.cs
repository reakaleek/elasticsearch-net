...
internal sealed partial class StatsConverter : System.Text.Json.Serialization.JsonConverter<Stats>
{
	...
	public override Stats Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		LocalJsonProperty<IReadOnlyDictionary<string, Elastic.Clients.Elasticsearch.Nodes.AdaptiveSelection>?> propAdaptiveSelection = default;
		LocalJsonProperty<IReadOnlyDictionary<Elastic.Clients.Elasticsearch.Field, string>?> propAttributes = default;
		LocalJsonProperty<IReadOnlyDictionary<string, Elastic.Clients.Elasticsearch.Nodes.Breaker>?> propBreakers = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Nodes.Discovery?> propDiscovery = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Nodes.FileSystem?> propFs = default;
		LocalJsonProperty<string?> propHost = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Nodes.Http?> propHttp = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Nodes.IndexingPressure?> propIndexingPressure = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.IndexManagement.ShardStats?> propIndices = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Nodes.Ingest?> propIngest = default;
		LocalJsonProperty<IReadOnlyCollection<string>?> propIp = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Nodes.Jvm?> propJvm = default;
		LocalJsonProperty<string?> propName = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Nodes.OperatingSystem?> propOs = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Nodes.Process?> propProcess = default;
		LocalJsonProperty<IReadOnlyCollection<Elastic.Clients.Elasticsearch.NodeRole>?> propRoles = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Nodes.Scripting?> propScript = default;
		LocalJsonProperty<IReadOnlyDictionary<string, Union<Elastic.Clients.Elasticsearch.Nodes.ScriptCache, IReadOnlyCollection<Elastic.Clients.Elasticsearch.Nodes.ScriptCache>>>?> propScriptCache = default;
		LocalJsonProperty<IReadOnlyDictionary<string, Elastic.Clients.Elasticsearch.Nodes.ThreadCount>?> propThreadPool = default;
		LocalJsonProperty<long?> propTimestamp = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Nodes.Transport?> propTransport = default;
