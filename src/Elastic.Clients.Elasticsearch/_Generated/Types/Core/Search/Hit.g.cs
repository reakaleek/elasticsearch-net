...
internal sealed partial class HitConverter<TDocument> : System.Text.Json.Serialization.JsonConverter<Hit<TDocument>>
{
	...
	public override Hit<TDocument> Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Core.Explain.Explanation?> propExplanation = default;
		...
		LocalJsonProperty<IReadOnlyDictionary<string, IReadOnlyCollection<Elastic.Clients.Elasticsearch.FieldValue>>?> propIgnoredFieldValues = default;
		LocalJsonProperty<string> propIndex = default;
		LocalJsonProperty<IReadOnlyDictionary<string, Elastic.Clients.Elasticsearch.Core.Search.InnerHitsResult>?> propInnerHits = default;
		LocalJsonProperty<IReadOnlyCollection<string>?> propMatchedQueries = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Core.Search.NestedIdentity?> propNested = default;
