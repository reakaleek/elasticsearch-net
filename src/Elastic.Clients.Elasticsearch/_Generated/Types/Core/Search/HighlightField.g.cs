...
internal sealed partial class HighlightFieldConverter : System.Text.Json.Serialization.JsonConverter<HighlightField>
{
	...
	public override HighlightField Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Core.Search.BoundaryScanner?> propBoundaryScanner = default;
		LocalJsonProperty<string?> propBoundaryScannerLocale = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Core.Search.HighlighterFragmenter?> propFragmenter = default;
		...
		LocalJsonProperty<Elastic.Clients.Elasticsearch.QueryDsl.Query?> propHighlightQuery = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Fields?> propMatchedFields = default;
		...
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Core.Search.HighlighterOrder?> propOrder = default;
		...
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Core.Search.HighlighterTagsSchema?> propTagsSchema = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Core.Search.HighlighterType?> propType = default;
