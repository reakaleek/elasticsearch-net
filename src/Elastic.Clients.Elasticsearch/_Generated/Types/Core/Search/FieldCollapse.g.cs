...
internal sealed partial class FieldCollapseConverter : System.Text.Json.Serialization.JsonConverter<FieldCollapse>
{
	...
	public override FieldCollapse Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		LocalJsonProperty<ICollection<Elastic.Clients.Elasticsearch.Core.Search.InnerHits>?> propInnerHits = default;
		...
		while (reader.Read() && reader.TokenType is System.Text.Json.JsonTokenType.PropertyName)
		{
			...
			if (propInnerHits.TryRead(ref reader, options, PropInnerHits, typeof(SingleOrManyMarker<IReadOnlyCollection<Elastic.Clients.Elasticsearch.Core.Search.InnerHits>?, Elastic.Clients.Elasticsearch.Core.Search.InnerHits>)))
			{
				continue;
			}
...
,
	...
	public override void Write(System.Text.Json.Utf8JsonWriter writer, FieldCollapse value, System.Text.Json.JsonSerializerOptions options)
	{
		...
		writer.WriteProperty(options, PropInnerHits, value.InnerHits, typeof(SingleOrManyMarker<IReadOnlyCollection<Elastic.Clients.Elasticsearch.Core.Search.InnerHits>?, Elastic.Clients.Elasticsearch.Core.Search.InnerHits>));
