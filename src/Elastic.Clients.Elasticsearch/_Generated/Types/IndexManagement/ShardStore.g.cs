...
internal sealed partial class ShardStoreConverter : System.Text.Json.Serialization.JsonConverter<ShardStore>
{
	...
	public override ShardStore Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		LocalJsonProperty<Elastic.Clients.Elasticsearch.IndexManagement.ShardStoreNode> propNode = default;
		LocalJsonProperty<string> propNodeId = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.IndexManagement.ShardStoreAllocation> propAllocation = default;
		LocalJsonProperty<string?> propAllocationId = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.IndexManagement.ShardStoreException?> propStoreException = default;
