...
internal sealed partial class AddActionConverter : System.Text.Json.Serialization.JsonConverter<AddAction>
{
	...
	public override AddAction Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		LocalJsonProperty<Elastic.Clients.Elasticsearch.IndexAlias?> propAlias = default;
		LocalJsonProperty<ICollection<Elastic.Clients.Elasticsearch.IndexAlias>?> propAliases = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.QueryDsl.Query?> propFilter = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.IndexName?> propIndex = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Routing?> propIndexRouting = default;
		...
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Routing?> propSearchRouting = default;
		while (reader.Read() && reader.TokenType is System.Text.Json.JsonTokenType.PropertyName)
		{
			...
			if (propAliases.TryRead(ref reader, options, PropAliases, typeof(SingleOrManyMarker<IReadOnlyCollection<Elastic.Clients.Elasticsearch.IndexAlias>?, Elastic.Clients.Elasticsearch.IndexAlias>)))
			{
				continue;
			}
...
,
	...
	public override void Write(System.Text.Json.Utf8JsonWriter writer, AddAction value, System.Text.Json.JsonSerializerOptions options)
	{
		...
		writer.WriteProperty(options, PropAliases, value.Aliases, typeof(SingleOrManyMarker<IReadOnlyCollection<Elastic.Clients.Elasticsearch.IndexAlias>?, Elastic.Clients.Elasticsearch.IndexAlias>));
