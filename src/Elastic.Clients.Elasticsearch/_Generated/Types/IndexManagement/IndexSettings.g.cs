...
internal sealed partial class IndexSettingsConverter : System.Text.Json.Serialization.JsonConverter<IndexSettings>
{
	...
	public override IndexSettings Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		LocalJsonProperty<Elastic.Clients.Elasticsearch.IndexManagement.IndexSettingsAnalysis?> propAnalysis = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.IndexManagement.SettingsAnalyze?> propAnalyze = default;
		LocalJsonProperty<string?> propAutoExpandReplicas = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.IndexManagement.IndexSettingBlocks?> propBlocks = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.IndexManagement.IndexCheckOnStartup?> propCheckOnStartup = default;
		...
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Duration?> propGcDeletes = default;
		LocalJsonProperty<object?> propHidden = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.IndexManagement.SettingsHighlight?> propHighlight = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.IndexManagement.IndexSettings?> propIndex = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.IndexManagement.IndexingPressure?> propIndexingPressure = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.IndexManagement.IndexingSlowlogSettings?> propIndexingSlowlog = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.IndexManagement.IndexSettingsLifecycle?> propLifecycle = default;
		LocalJsonProperty<bool?> propLoadFixedBitsetFiltersEagerly = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.IndexManagement.MappingLimitSettings?> propMapping = default;
		...
		LocalJsonProperty<Elastic.Clients.Elasticsearch.IndexManagement.Merge?> propMerge = default;
		...
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Name?> propProvidedName = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.IndexManagement.Queries?> propQueries = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.IndexManagement.SettingsQueryString?> propQueryString = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Duration?> propRefreshInterval = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.IndexManagement.IndexRouting?> propRouting = default;
		LocalJsonProperty<int?> propRoutingPartitionSize = default;
		LocalJsonProperty<ICollection<string>?> propRoutingPath = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.IndexManagement.SettingsSearch?> propSearch = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.IndexManagement.IndexSettings?> propSettings = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.IndexManagement.SettingsSimilarities?> propSimilarity = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.IndexManagement.SoftDeletes?> propSoftDeletes = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.IndexManagement.IndexSegmentSort?> propSort = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.IndexManagement.Storage?> propStore = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.IndexManagement.IndexSettingsTimeSeries?> propTimeSeries = default;
		LocalJsonProperty<int?> propTopMetricsMaxSize = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.IndexManagement.Translog?> propTranslog = default;
		LocalJsonProperty<string?> propUuid = default;
		LocalJsonProperty<object?> propVerifiedBeforeClose = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.IndexManagement.IndexVersioning?> propVersion = default;
