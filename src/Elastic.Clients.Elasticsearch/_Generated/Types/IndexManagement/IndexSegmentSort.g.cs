...
internal sealed partial class IndexSegmentSortConverter : System.Text.Json.Serialization.JsonConverter<IndexSegmentSort>
{
	...
	public override IndexSegmentSort Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Fields?> propField = default;
		LocalJsonProperty<ICollection<Elastic.Clients.Elasticsearch.IndexManagement.SegmentSortMissing>?> propMissing = default;
		LocalJsonProperty<ICollection<Elastic.Clients.Elasticsearch.IndexManagement.SegmentSortMode>?> propMode = default;
		LocalJsonProperty<ICollection<Elastic.Clients.Elasticsearch.IndexManagement.SegmentSortOrder>?> propOrder = default;
		while (reader.Read() && reader.TokenType is System.Text.Json.JsonTokenType.PropertyName)
		{
			...
			if (propMissing.TryRead(ref reader, options, PropMissing, typeof(SingleOrManyMarker<IReadOnlyCollection<Elastic.Clients.Elasticsearch.IndexManagement.SegmentSortMissing>?, Elastic.Clients.Elasticsearch.IndexManagement.SegmentSortMissing>)))
			{
				continue;
			}

			if (propMode.TryRead(ref reader, options, PropMode, typeof(SingleOrManyMarker<IReadOnlyCollection<Elastic.Clients.Elasticsearch.IndexManagement.SegmentSortMode>?, Elastic.Clients.Elasticsearch.IndexManagement.SegmentSortMode>)))
			{
				continue;
			}

			if (propOrder.TryRead(ref reader, options, PropOrder, typeof(SingleOrManyMarker<IReadOnlyCollection<Elastic.Clients.Elasticsearch.IndexManagement.SegmentSortOrder>?, Elastic.Clients.Elasticsearch.IndexManagement.SegmentSortOrder>)))
			{
				continue;
			}
...
,
	...
	public override void Write(System.Text.Json.Utf8JsonWriter writer, IndexSegmentSort value, System.Text.Json.JsonSerializerOptions options)
	{
		...
		writer.WriteProperty(options, PropMissing, value.Missing, typeof(SingleOrManyMarker<IReadOnlyCollection<Elastic.Clients.Elasticsearch.IndexManagement.SegmentSortMissing>?, Elastic.Clients.Elasticsearch.IndexManagement.SegmentSortMissing>));
		writer.WriteProperty(options, PropMode, value.Mode, typeof(SingleOrManyMarker<IReadOnlyCollection<Elastic.Clients.Elasticsearch.IndexManagement.SegmentSortMode>?, Elastic.Clients.Elasticsearch.IndexManagement.SegmentSortMode>));
		writer.WriteProperty(options, PropOrder, value.Order, typeof(SingleOrManyMarker<IReadOnlyCollection<Elastic.Clients.Elasticsearch.IndexManagement.SegmentSortOrder>?, Elastic.Clients.Elasticsearch.IndexManagement.SegmentSortOrder>));
